function [DAG_ProcessorMerging, totalEnergyConsumption, ScheduleResultTOout, failureRate_PM, energySpec_PM, scheduleLength] ...
    = ProcessorMergingFuc( DAG, relReq, failureRate, energySpec, MSLscheduleLength)
