function [DAG_ProcessorMerging, totalEnergyConsumption, ScheduleResultTOout, scheduleLength] = ProcessorMergingFuc( DAG, relReq, failureRate, energySpec, MSLscheduleLength)
...
% [AFTForiTask,ScheduleResult] = MSLFuc( DAG, relReq, failureRate_backup);
% totalEnergyConsumption = EnergyConsumptionFuc(ScheduleResult, AFTForiTask, energySpec_backup);
...
%     for k = 1:size(Turn_Off_Pro_Array,2)
%         DAG_backup.Wcet(Turn_Off_Pro_Array(k),:) = 999;
%     end
end
