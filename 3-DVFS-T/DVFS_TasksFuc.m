function [DAG, totalEnergyConsumption, scheduleOut, frequencyArrayFinal, makeSpan] = DVFS_TasksFuc( DAG, relReq, failureRate, energySpec, d, MSLscheduleLength, MSLScheduleResult)
...
% totalEnergyConsumption = EnergyConsumptionFuc(MSLScheduleResult, MSLscheduleLength, energySpec);
